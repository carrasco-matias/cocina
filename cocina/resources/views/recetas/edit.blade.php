        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                  {{ $receta }}
<br>
    <button class="button bg-info">Guardar</button>
<br>
    <button class="button bg-info">Eliminar</button>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="relative mb-3" data-twe-input-wrapper-init>
                        <div class="mx-auto block max-w-sm rounded-lg bg-dark p-6 shadow-4 dark:bg-surface-dark">
                          <form>
                            <!--E-mail input-->
                            <div class="relative mb-12" data-twe-input-wrapper-init>
                              ...
                              <small
                                id="emailHelp"
                                class="absolute mt-2 w-full text-neutral-500 dark:text-neutral-200"
